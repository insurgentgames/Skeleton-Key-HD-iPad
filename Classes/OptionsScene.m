...
- (id) init {
	if((self=[super init])) {
		...
		if(!gameData.returnToGame) {
			...
			resetMenu.position = ccp(384, 223);
...
- (void) onReset:(id)sender {
	...
	background.position = ccp(384, 592);
...
- (void)ccTouchEnded:(UITouch *)touch withEvent:(UIEvent *)event {
	...
	CGRect soundRect = CGRectMake(64, 649, 641, 120);
	CGRect musicRect = CGRectMake(64, 530, 641, 120);
	CGRect shakeRect = CGRectMake(64, 410, 641, 120);
